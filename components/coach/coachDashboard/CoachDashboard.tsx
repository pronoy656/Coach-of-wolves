...
//     switch (activeTab) {
//       case "Daily Tracking":
//         return <div className="text-gray-400">This is daily tracking tab</div>;
//       case "Check-Ins":
//         return <div className="text-gray-400">This is check in tab</div>;
//       case "Training":
//         return <div className="text-gray-400">This is training tab</div>;
//       case "Nutrition":
//         return <div className="text-gray-400">This is nutrition tab</div>;
//       case "Supplements":
//         return <div className="text-gray-400">This is supplements tab</div>;
//       case "Timeline":
//         return <div className="text-gray-400">This is timeline tab</div>;
//       case "PED":
//         return <div className="text-gray-400">This is PED tab</div>;
//       default:
//         return null;
//     }
//   };
...
//       {/* --- Navigation Tabs --- */}
//       <div className="inline-flex w-full items-center rounded-full bg-[#121225] px-2 py-2 sm:w-auto border border-white/5">
//         <div className="flex w-full flex-row items-center justify-between gap-1 overflow-x-auto no-scrollbar sm:justify-start">
//           {tabs.map((tab) => (
//             <button
//               key={tab}
//               onClick={() => setActiveTab(tab)}
//               className={`
//                 whitespace-nowrap rounded-full px-6 py-2.5 text-sm font-medium transition-all duration-200
//                 ${
//                   activeTab === tab
