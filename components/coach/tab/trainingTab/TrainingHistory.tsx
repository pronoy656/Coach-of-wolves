...
//         <div>
//           <h2 className="text-3xl font-bold">Training History</h2>
//           <p className="text-gray-400 mt-1">Track your workouts and personal records</p>
//         </div>
...
//           <p className="text-gray-400">Start logging your workouts to see your training history here.</p>
//         </div>
//       )}
...
//               {selectedWorkouts.slice(0, 2).map((workout, index) => (
...
//                     <div className="space-y-3">
//                       {workout.exercises.slice(0, 2).map((exercise, exIndex) => (
...
//                     selectedWorkouts[0].exercises.map((exercise, index) => (
//                       <div key={index} className="pb-4 border-b border-[#2a2a2a] last:border-0 last:pb-0">
...
//                         {selectedWorkouts[0].exercises?.reduce((total, ex) => total + (ex.sets?.length || 0), 0) || 0}
//                       </div>
