...
//         <div className="bg-[#08081A] border border-[#303245] rounded-lg p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto scrollbar-none">
...
//               <button
//                 type="submit"
//                 className="flex-1 px-6 py-3 bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-lg text-white font-semibold hover:from-emerald-400 hover:to-emerald-500 transition-colors"
//               >
//                 Save
//               </button>
//             </div>
