...
//                   className="w-full px-4 py-2.5 bg-card border border-border rounded-lg text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary"
//                 />
//               </div>
...
//                 className="px-6 py-2.5 border border-primary text-primary rounded-full font-medium hover:bg-primary/10 transition-colors whitespace-nowrap"
//               >
//                 + Add Exercise
//               </button>
//             </div>
...
//                 <div
//                   key={exercise.id}
//                   className="bg-gradient-to-br from-card to-card/80 border border-border rounded-xl p-6 hover:shadow-lg hover:border-primary/50 transition-all duration-300 flex flex-col h-full group"
//                 >
...
//                         {exercise.subcategories.map((sub) => (
//                           <span
//                             key={sub}
//                             className="px-3 py-1 text-xs font-medium bg-primary/15 text-primary rounded-full border border-primary/30 hover:bg-primary/25 transition-colors"
//                           >
//                             {sub}
//                           </span>
//                         ))}
